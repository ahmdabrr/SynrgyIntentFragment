...
class BundleFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnNextBundle.setOnClickListener{
            if (etBundleName.text.toString().isEmpty() && etBundleUmur.text.toString().isEmpty())
            {
                Toast.makeText(
                    context,
                ...
                val nama = etBundleName.text
                val umur = Integer.parseInt(etBundleUmur.text.toString())
